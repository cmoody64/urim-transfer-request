...
export const BoxForm = (props) => {
    ...
    const updateBoxFormComponent = (e) => {
        updateFormSingleBoxData(e.target.id, e.target.value, props.key)
    }
    ...
    return (
        <Grid>
            ...
            <Row>
                <FieldGroup id='boxNumber' type='text' label='Box No.' span={1} value={props.box['boxNumber']}
